    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Controlando el tránsito y asistiendo a las víctimas
        p.mb-4 Fortalecer conceptos y saberes sobre red vial, para manejo del y atención en primeros auxilios, con base en los temas del componente formativo.
